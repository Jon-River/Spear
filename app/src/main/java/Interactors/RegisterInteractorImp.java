...
public class RegisterInteractorImp implements RegisterInteractor {
    ...
    @Override
    public void registerUser(final View view, final EditText user, final EditText email, EditText password) {
        ...
        dialog.show();
        if (TextUtils.isEmpty(emailString) || TextUtils.isEmpty(userString) || TextUtils.isEmpty(passwString)) {
            ...
            firebaseAuth.createUserWithEmailAndPassword(emailString,passwString).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()){
                        ...
                        UserInfo userData = new UserInfo(userString, emailString, user.getUid());
