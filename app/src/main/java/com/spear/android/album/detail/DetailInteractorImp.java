...
public class DetailInteractorImp implements DetailInteractor {

    DetailView.OnPushRatingToFirebase onPushRating;
    private DatabaseReference databaseReference;

    public DetailInteractorImp(DetailView.OnPushRatingToFirebase onPushRating) {
